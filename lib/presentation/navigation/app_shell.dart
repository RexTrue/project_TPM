...
class _AppShellState extends State<AppShell> {
  ...
  Future<void> _handleLogoutTap() async {
    ...
    Navigator.of(
      context,
    ).pushNamedAndRemoveUntil(AppNavigation.login, (route) => false);
  }
        ...
        children: [
          Card(
            child: ListTile(
              ...
              subtitle: const Text('Miringkan HP untuk memilih jawaban'),
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => const QuizMinigameScreen()),
                );
              },
            ),
          ),
          Card(
            child: ListTile(
              ...
              title: const Text('Spin Rush'),
              subtitle: const Text('Putar atau goyangkan HP untuk isi energi'),
              onTap: () {
                Navigator.push(
                  context,
